...
function calculator(inputPeople, inputDays, inputSelect, totalId) {
  var restPeople = document.querySelectorAll(inputPeople)[0],
...
function submitForm(formMainClass, formContactId, inputTag, statusStyle) {
  ...
  statusMessage.classList.add(statusStyle); // FORM + promise
...
function mod(btn, btnArray, overlayClass, btnClose, btnStyle) {
  var btnModWind = document.querySelector(btn),
...
function slider(slidesClass, btnPrev, btnNext, dotsWrapper, dotsClass, dotsActiveClass) {
  ...
  function showSlides(n) {
    ...
    dots.forEach(function (item) {
      return item.classList.remove(dotsActiveClass);
    });
...
function timer(idTimer, endtime, secondsClass, minutesClass, hoursClass, daysClass) {
  ...
  function updateClock() {
    var upTime = getTimeRemaining(endtime);
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var tabs = __webpack_require__(/*! ./parts/tabs.js */ "./src/js/parts/tabs.js"),
      ...
      mod = __webpack_require__(/*! ./parts/modal.js */ "./src/js/parts/modal.js"),
      submitForm = __webpack_require__(/*! ./parts/form.js */ "./src/js/parts/form.js"),
      slider = __webpack_require__(/*! ./parts/slider */ "./src/js/parts/slider.js"),
      calculator = __webpack_require__(/*! ./parts/calc.js */ "./src/js/parts/calc.js"); // Tabs


  tabs('.info-header-tab', '.info-header', '.info-tabcontent'); // Timer

  timer('timer', '2019-12-15', '.seconds', '.minutes', '.hours', '.days'); // Modal

  mod('.more', '.description-btn', '.overlay', '.popup-close', 'more-splash'); // Form

  submitForm('.main-form', 'form', 'input', 'status'); // Slider

  slider('.slider-item', '.prev', '.next', '.slider-dots', 'dot', 'dot-active'); // Calc
